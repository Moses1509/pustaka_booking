...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#bukuBaruModal"><i class="fas fa-file-alt"></i> Tambah Buku Baru</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <picture>
                                    ...
                                    <img src="<?= base_url('assets/img/upload/') . $b['image']; ?>" class="img-fluid img-thumbnail" alt="..." width="1000">
                                </picture>
                            </td>
                            <td><?= $b['judul_buku']; ?></td>
                            <?php
                            if ($b['id_kategori'] == '1') {
                                echo "<td>Komputer</td>";
                            } else if ($b['id_kategori'] == '2') {
                                echo "<td>Bahasa</td>";
                            } else if ($b['id_kategori'] == '3') {
                                echo "<td>Sains</td>";
                            } else if ($b['id_kategori'] == '4') {
                                echo "<td>Hobby</td>";
                            } else if ($b['id_kategori'] == '5') {
                                echo "<td>Komunikasi</td>";
                            } else if ($b['id_kategori'] == '6') {
                                echo "<td>Hukum</td>";
                            } else if ($b['id_kategori'] == '7') {
                                echo "<td>Agama</td>";
                            } else if ($b['id_kategori'] == '8') {
                                echo "<td>Populer</td>";
                            } else if ($b['id_kategori'] == '9') {
                                echo "<td>Komik</td>";
                            } else if ($b['id_kategori'] == '12') {
                                echo "<td>Fiction</td>";
                            }
                            ?>
                            <td><?= $b['pengarang']; ?></td>
